...
def check_connection():
    ...
    print(
        ...
        else f"Connection failed: {response.text}"
    )
...
def request_word():
    ...
    print(
        response.json()
        if response.status_code == 200
        else f"Word request failed: {response.text}"
    )
...
def request_int():
    ...
    print(
        response.json()
        if response.status_code == 200
        else f"Integer request failed: {response.text}"
    )
...
def request_even(client_id):
    ...
    print(
        response.json()
        if response.status_code == 200
        else f"Even number request failed: {response.text}"
    )
...
def request_odd(client_id):
    ...
    print(
        response.json()
        if response.status_code == 200
        else f"Odd number request failed: {response.text}"
    )
...
def pass_ident(client_id):
    ...
    print(
        response.json()
        if response.status_code == 200
        else f"Identification failed: {response.text}"
    )
...
def get_last_number(client_id):
    ...
    print(
        response.json()
        if response.status_code == 200
        else f"Failed to get last number: {response.text}"
    )
